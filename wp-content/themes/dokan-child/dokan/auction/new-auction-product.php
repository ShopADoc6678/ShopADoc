                                        ...
                                        <div class="photo_inner_div featured-image_panorex">
                                            <div class="upload_section dokan-feat-image-upload_panorex">
                                                <div class="instruction-inside">
                                                    ...
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_panorex dokan-btn"><?php _e( 'Upload panorex X-ray', 'dokan-auction' ); ?></a><br /><a class="example_link" href="#" caption="abc" data-featherlight="<?php echo home_url('/wp-content/uploads/panorex-l.jpg');?>"><span class="wp-caption-text hide">Panorex Film</span>See example</a>
                                                </div>
                                        ...
                                        <div class="photo_inner_div featured-image_bitewing">
                                            <div class="upload_section dokan-feat-image-upload_bitewing">
                                                <div class="instruction-inside">
                                                    ...
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_bitewing dokan-btn"><?php _e( 'Upload bitewing X-rays', 'dokan-auction' ); ?></a><br /><a class="example_link" href="#" data-featherlight="<?php echo home_url('/wp-content/uploads/bitewing-l.jpg');?>"><span class="wp-caption-text hide">Bitewing Films (bws)</span>See example</a>
                                                </div>
                                            ...
                                            <div class="upload_section dokan-feat-image-upload_full_mouth">
                                                <div class="instruction-inside">
                                                   <input id="feat_image_id_full_mouth" type="hidden" name="feat_image_id_full_mouth" class="dokan-feat-image-id_full_mouth" value="<?php if($feat_image_id_full_mouth > 0){ echo $feat_image_id_full_mouth;}else{ echo '0';}?>">
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_full_mouth dokan-btn"><?php _e( 'Upload full mouth series X-rays', 'dokan-auction' ); ?></a><br /><a  class="example_link" href="#" data-featherlight="<?php echo home_url('/wp-content/uploads/full-mouth-series-l.jpg');?>"><span class="wp-caption-text hide">Full Mouth Series (fmx)</span>See example</a>
                                                </div>
                                            ...
                                            <div class="upload_section dokan-feat-image-upload_sample1">
                                                <div class="instruction-inside">
                                                   <input id="feat_image_id_sample1" type="hidden" name="feat_image_id_sample1" class="dokan-feat-image-id_sample1" value="<?php if($feat_image_id_sample1 > 0){ echo $feat_image_id_sample1;}else{ echo '0';}?>">
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_sample1 dokan-btn"><?php _e( 'Upload Full Frontal Smile photo', 'dokan-auction' ); ?></a><br /><a  class="example_link" href="#" data-featherlight="<?php echo home_url('/wp-content/uploads/1-Wide-Smile-new.jpg');?>"><span class="wp-caption-text hide">Full Frontal Smile</span>See example</a>
                                                </div>
                                        ...
                                        <div class="photo_inner_div featured-image_periapical_2">
                                            <div class="upload_section dokan-feat-image-upload_periapical_2">
                                                <div class="instruction-inside">
                                                    ...
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_periapical_2 dokan-btn"><?php _e( 'Upload periapical X-ray', 'dokan-auction' ); ?></a><br /><a class="example_link" href="#" data-featherlight="<?php echo home_url('/wp-content/uploads/periapical-l.jpg');?>"><span class="wp-caption-text hide">Periapical Film (pa)</span>See example</a>
                                            ...
                                            <div class="upload_section dokan-feat-image-upload_sample4">
                                                <div class="instruction-inside">
                                                   <input id="feat_image_id_sample4" type="hidden" name="feat_image_id_sample4" class="dokan-feat-image-id_sample4" value="<?php if($feat_image_id_sample4 > 0){ echo $feat_image_id_sample4;}else{ echo '0';}?>">
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_sample4 dokan-btn"><?php _e( 'Upload Profile photo', 'dokan-auction' ); ?></a><br /><a  class="example_link" href="#" data-featherlight="<?php echo home_url('/wp-content/uploads/4-Profile-new.jpg');?>"><span class="wp-caption-text hide">Profile</span>See example</a>
                                                </div>
                                            ...
                                            <div class="upload_section dokan-feat-image-upload_sample2">
                                                <div class="instruction-inside">
                                                   <input id="feat_image_id_sample2" type="hidden" name="feat_image_id_sample2" class="dokan-feat-image-id_sample2" value="<?php if($feat_image_id_sample2 > 0){ echo $feat_image_id_sample2;}else{ echo '0';}?>">
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_sample2 dokan-btn"><?php _e( 'Upload Maxillary Top Arch photo', 'dokan-auction' ); ?></a><br /><a  class="example_link" href="#" data-featherlight="<?php echo home_url('/wp-content/uploads/2-Upper-Teeth-new.jpg');?>"><span class="wp-caption-text hide">Maxillary Top Arch</span>See example</a>
                                                </div>
                                            ...
                                            <div class="upload_section dokan-feat-image-upload_sample3">
                                                <div class="instruction-inside">
                                                   <input id="feat_image_id_sample3" type="hidden" name="feat_image_id_sample3" class="dokan-feat-image-id_sample3" value="<?php if($feat_image_id_sample3 > 0){ echo $feat_image_id_sample3;}else{ echo '0';}?>">
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <a href="#" class="dokan-feat-image-btn_sample3 dokan-btn"><?php _e( 'Upload Mandibular Bottom Arch photo', 'dokan-auction' ); ?></a><br /><a  class="example_link" href="#" data-featherlight="<?php echo home_url('/wp-content/uploads/3-Lower-Teeth-new.jpg');?>"><span class="wp-caption-text hide">Mandibular Bottom Arch</span>See example</a>
                                                </div>
