 ...
 -webkit-backdrop-filter: blur(8px);
  ...
  opacity:1;
            ...
            <script type="text/javascript">
					...
					//audio-5486-1_html5
					<?php if(isset($_GET['action']) && $_GET['action']=='extended'){}else{?>
					setTimeout(function(){
						...
						if (timetext == 'Pause') {
							...
							jQuery.confirm({
								...
								content: '<img src="<?php echo home_url('/wp-content/themes/dokan-child/play_btn_black.png');?>" title="ENTER" class="play_btn_black" align="center" style="float:none;display:none;margin:0 auto;" onclick="jQuery(\'.jconfirm-buttons button\').click();"/>',
								buttons: {
									Yes: {
										text: "ENTER",
