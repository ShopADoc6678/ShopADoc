...
$_billing_full_name = $order->get_meta('_billing_full_name');
$_order_terms_text = $order->get_meta('_order_terms_text');
...
<table cellspacing="0" cellpadding="0" style="width: 100%; vertical-align: top; margin-bottom: 40px; padding:0;" border="0">
	<tr>
		<td style="text-align:<?php echo esc_attr( $text_align ); ?>; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; border:0; padding:0;" valign="top" width="50%">
			<p><?php echo $_order_terms_text;?></p>
	...
	<tr>
		<td style="text-align:<?php echo esc_attr( $text_align ); ?>; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; border:0; padding:0;" valign="top" width="50%">
			...
			<address class="address">
				...
				<?php if ( $order->get_billing_email() && 1==2) : ?>
