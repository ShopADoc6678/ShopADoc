          ...
          <div id="details" >
            <div id="filter_date" >
              ...
              <form method="post" class="feeForm" id="feeForm">
                <div class="fee_section">
                  ...
                  <p >
                    ...
                    </span><!--<input type="button" class="button" name="D_Subscription" value="$<?php echo number_format($price_subscription, 2, '.', '');?>" onclick="feePopup('D_Subscription',948);"/>--></p>
                  <p >
                    <label><strong>Relist Fee</strong></label>
                    <span class="currencyinput"><span class="symbol">$</span>
                    ...
                    </span><!--<input type="button" class="button" name="Relist_Fee" value="$<?php echo number_format($price_relist, 2, '.', '');?>" onclick="feePopup('Relist_Fee',1642);"/>--> <input type="submit" value="Save" class="btn btn-primary" style="margin-left:45px;"/></p>
              ...
              <?php /*?>
               ...
               <p ><label><strong>Relist Fee</strong></label> <input type="button" class="button" name="Relist_Fee" value="$<?php echo number_format($price_relist, 2, '.', '');?>" onclick="feePopup('Relist_Fee',1642);"/></p>
               </div>
			   <?php */?>
            </div>
