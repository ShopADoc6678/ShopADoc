;(function($) {
    ...
    var Dokan_search_store_support_tickets = {
        init : function () {
            ...
            // Date range format to display
            let dateRangeFormat = dokan_get_daterange_picker_format();
            ...
            $("#support_ticket_date_filter").daterangepicker({
                ...
                locale: {
                  ...
                  applyLabel: dokan_daterange_i18n.apply_label,
                  cancelLabel: dokan_daterange_i18n.clear_label
                }
