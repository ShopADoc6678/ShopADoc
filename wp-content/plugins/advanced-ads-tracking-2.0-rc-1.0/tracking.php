...
function advanced_ads_tracking_init_plugin () {
    ...
    if ( $is_admin && !$is_ajax ) {
        ...
        register_deactivation_hook( __FILE__, 'advanced_ads_tracking_deactivation' );
    }
    
    // check if debugging is enabled
	add_action( 'update_option_' . Advanced_Ads_Tracking_Debugger::DEBUG_OPT, [ 'Advanced_Ads_Tracking_Debugger', 'trigger_installer_update' ] );
	add_action( 'delete_option_' . Advanced_Ads_Tracking_Debugger::DEBUG_OPT, [ 'Advanced_Ads_Tracking_Debugger', 'trigger_installer_update' ] );
