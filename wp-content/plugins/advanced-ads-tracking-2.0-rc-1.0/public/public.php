...
class Advanced_Ads_Tracking {
    ...
    public function url_redirect(){
        ...
        if ( $ad_id ) {
            ...
            if( $url ){
                ...
                Advanced_Ads_Tracking_Util::get_instance()->track_click($args, $start_time);
    ...
    public function track_on_shutdown() {
        ...
        foreach ( $advads->current_ads as $_ad ) {
	        ...
	        if ( ( isset( $tracking_options['method'] ) && 'frontend' === $tracking_options['method'] ) && isset( $_ad['placement_id'] ) ) {
            ...
            Advanced_Ads_Tracking_Util::get_instance()->track_impression( $args, $start_time );
        }
    }
