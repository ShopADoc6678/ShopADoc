...
<div class="wrap">
	...
	<table class="widefat">
		...
		<tr class="alternate">
			...
			<td <?php if ( Advanced_Ads_Tracking_Dbop::row_count_limit() && Advanced_Ads_Tracking_Dbop::row_count_limit() < $db_size['impression_row_count'] )
				echo 'style="color:red;"' ?>><?php echo $db_size['impression_row_count']; ?></td>
		...
		<tr>
			...
			<td <?php if ( Advanced_Ads_Tracking_Dbop::row_count_limit() && Advanced_Ads_Tracking_Dbop::row_count_limit() < $db_size['click_row_count'] )
				echo 'style="color:red;"' ?>><?php echo $db_size['click_row_count']; ?></td>
