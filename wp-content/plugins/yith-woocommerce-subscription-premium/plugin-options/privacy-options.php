...
<br>Note: All the subscriptions will change the status to cancelled if the personal data will be removed.', 'yith-woocommerce-subscription' ), esc_url( admin_url( 'tools.php?page=remove_personal_data' ) ) ),
