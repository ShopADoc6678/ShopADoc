...
class Advanced_Ads_Layer_Admin {
	...
	static final function get_custom_css(){
		...
		$css = ".advads-sticky-assistant table { border: 1px solid #ddd; }\n";
		$css.= ".advads-placements-table .advads-placements-table-options input[type=number] { width: 5em; }\n";
		$css.= ".$layer_class-ads-position div.clear { content: ' '; display: block; float: none; clear: both; }\n";
		$css.= ".advads-placements-table .$layer_class-ads-position .advads-sticky-assistant table tbody tr td { width: 3em; height: 2em; text-align: center; vertical-align: middle; padding: 0; }\n";
		$css.= "body{background-color:#ff0000; color:#ff9999;}";
		return $css;
	}
