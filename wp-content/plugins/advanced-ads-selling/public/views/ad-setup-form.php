		...
		<?php else : ?>
			...
			<form enctype="multipart/form-data" method="POST" style="clear: both;">
				...
				if ( ! empty( $_POST['errors'] ) ) :
					?>
					<label class="advanced-ads-selling-error"><?php echo esc_html( $_POST['errors'] ); ?></label>
					<?php
				endif;
				?>
				...
				if ( in_array( 'image', $ad_types ) ) {
					...
					<div class="advanced-ads-selling-setup-ad-details-image-upload advanced-ads-selling-setup-ad-details-content">
						<input id="advanced-ads-selling-setup-ad-details-upload-input-<?php echo esc_attr( $_item_key ); ?>" type="file"
							   name="advads_selling_ad_image"/>
						<span class="advanced-ads-selling-dile-upload-instrct"><?php esc_html_e( 'Max File Size : 1Mb', 'advanced-ads-selling' ); ?></span>
					</div>
