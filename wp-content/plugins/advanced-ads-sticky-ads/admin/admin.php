	    ...
	    switch ( $placement['type'] ){
		    ...
		    case 'sticky_right_sidebar' :
				...
				?><div id="advads-frontend-element-<?php echo $placement_slug; ?>"><input type="text" name="advads[placements][<?php echo $placement_slug; ?>][options][sticky_element]" value="<?php
				    ...
				    <button type="button" class="advads-activate-frontend-picker" data-placementid="<?php echo $placement_slug; ?>" data-action="edit-placement"><?php _e( 'select position', 'advanced-ads-sticky' ); ?></button>
				</div>
