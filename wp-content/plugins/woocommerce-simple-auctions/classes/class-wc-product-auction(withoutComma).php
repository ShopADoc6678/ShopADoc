	...
	public function bid_value() {
		...
		if ( ! $this->get_auction_current_bid() ) {
			...
			if($this->get_auction_type() == 'reverse' ){
				...
				return apply_filters('woocommerce_simple_auctions_bid_value' ,round( wc_format_decimal($this->get_curent_bid()) - wc_format_decimal($auction_bid_increment),wc_get_price_decimals_mujahid()), $this);
