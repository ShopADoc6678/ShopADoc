      ...
      for ($i = 0; $i < count($metrics); $i++) {
		...
		if($dimensions[1] =='Clicks'  || $dimensions[1] =='Impressions' ){
			...
			if($dimensions[1]=='Clicks'){
				$ad_array[$dimensions[0]]['Clicks'] = ( isset($values[0]) && $values[0] ) ? $values[0] : '0';
				$ad_array[$dimensions[0]]['UClicks'] =  ( isset($values[1]) && $values[1] ) ? $values[1] : '0';
			}
			if($dimensions[1]=='Impressions'){
				$ad_array[$dimensions[0]]['Impressions'] =  ( isset($values[0]) && $values[0] ) ? $values[0] : '0';
				$ad_array[$dimensions[0]]['UImpressions'] =  ( isset($values[1]) && $values[1] ) ? $values[1] : '0';
			}
		}
		//print_r($values);
      }
...
<div class="wrap">
	<div class="GA_logo"><img src="/wp-content/plugins/WP_GA/Google-Analytics-Logo.png" align="left" alt="" title="Google-Analytics-Logo" width="170px" />
    <a href="javascript:" class="not_print print" style="float:right;"><img src="/wp-content/plugins/WP_GA/print.png" align="right" title="print" width="20px" class="print_icon"/></a>
    </div>
            	...
            	<?php foreach($results as $key=>$result){
					...
					?>
                        <tr class="content">
                            ...
                            <td align="left" style="text-align:left !important;"><?php echo $ad_title;?></td>
