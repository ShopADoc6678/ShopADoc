        ...
        <div class="meta-box-sortables ui-sortable">
          <style type="text/css">
				 ...
				 .containerMain .col{
					...
					.ad_details label{font-size:10px;color:#707070;margin:0;}
					.ad_details .popup_val{color:#000;font-size:11px;font-weight:bold;}
					.ad_details img{width:100%;max-width:100%;}
					.ad_details .row,.ad_details .col{border:none;text-align:left;}
					.edit_link,.delete_link{font-size:9px;font-weight:bold;}
					...
					.btn {
							...
							.wc-wp-version-gte-53 .select2-dropdown--below {
								...
								.wc-wp-version-gte-53 .select2-container .select2-selection--single .select2-selection__arrow{z-index:0;}
						</style>
          <div style="float:left;width:100%;">
            <?php 
				...
				foreach($users as $user){
					$query = "SELECT * FROM wp_posts where post_author = '".$user->ID."'and (post_status = 'publish' or post_status = 'future') and post_type = 'advanced_ads' and ( post_title like '%C %' or post_excerpt = 'C' ) ORDER BY ID ASC";
					$results = $wpdb->get_results($query, OBJECT);
					if ($wpdb->num_rows > 0) {
				...
				?>
                  <div class="row">
                    ...
                    <div class="col" id="<?php echo $option_name1."_main"?>"> <span id="<?php echo $option_name1;?>_view" class="view_main">
                      ...
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name1;?>','C','<?php echo get_option($option_name1);?>');"><?php echo $ad_demo_company_name1;?></a></span><span id="<?php echo $option_name1;?>_detail_popup" class="detail_View">&nbsp; 
                      <script type="text/javascript">
                      ...
                      <?php /*?><span  id="<?php echo $option_name1;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name1;?>_select','C');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                    <div class="col" id="<?php echo $option_name2."_main"?>"> <span id="<?php echo $option_name2;?>_view" class="view_main">
                      ...
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name2;?>','C','<?php echo get_option($option_name2);?>');"><?php echo $ad_demo_company_name2;?></a></span><span id="<?php echo $option_name2;?>_detail_popup" class="detail_View">&nbsp;
                      <?php }/*else{*/?>
                      </span>
                      ...
                      <?php /*?><span  id="<?php echo $option_name2;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name2;?>_select','C');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                    <div class="col" id="<?php echo $option_name3."_main"?>"> <span id="<?php echo $option_name3;?>_view" class="view_main">
                      ...
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name3;?>','C','<?php echo get_option($option_name3);?>');"><?php echo $ad_demo_company_name3;?></a></span><span id="<?php echo $option_name3;?>_detail_popup" class="detail_View">&nbsp;
                      <?php }/*else{*/?>
                      </span>
                      ...
                      <?php /*?><span  id="<?php echo $option_name3;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name3;?>_select','C');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                    <div class="col" id="<?php echo $option_name4."_main"?>"> <span id="<?php echo $option_name4;?>_view" class="view_main">
                      ...
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name4;?>','C','<?php echo get_option($option_name4);?>');"><?php echo $ad_demo_company_name4;?></a></span><span id="<?php echo $option_name4;?>_detail_popup" class="detail_View">&nbsp;
                      <?php }/*else{*/?>
                      </span>
                      ...
                      <?php /*?><span  id="<?php echo $option_name4;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name4;?>_select','C');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                  </div>
                  <script type="text/javascript">
						...
						function formatState (state) {
						  if (!state.id || state.text =='+ Add Creative') {
							  if(state.text =='+ Add Creative'){
            ...
            <?php 
				...
				$html1 = '';
				foreach($users as $user){
					$query = "SELECT * FROM wp_posts where post_author = '".$user->ID."'and (post_status = 'publish' or post_status = 'future') and post_type = 'advanced_ads' and ( post_title like '%D %' or post_excerpt = 'D' ) ORDER BY ID ASC";
					$results = $wpdb->get_results($query, OBJECT);
					if ($wpdb->num_rows > 0) {
						$ad_demo_company_name_group = get_user_meta($user->ID, 'ad_demo_company_name',true);
						$html1 .='<optgroup label="'.$ad_demo_company_name_group.'">';
              ...
              <div class="containerMain">
                <div class="container">
                  ...
                  <div class="row">
                    ...
                    <div class="col" id="<?php echo $option_name1."_main"?>"> <span id="<?php echo $option_name1;?>_view" class="view_main">
                      <?php if(get_option($option_name1) !=""){?>
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name1;?>','D','<?php echo get_option($option_name1);?>');"><?php echo $ad_demo_company_name1;?></a></span><span id="<?php echo $option_name1;?>_detail_popup" class="detail_View">&nbsp;
                      <?php }/*else{*/?>
                      </span>
                      ...
                      <?php /*?><span  id="<?php echo $option_name1;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name1;?>_select','D');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                    <div class="col" id="<?php echo $option_name2."_main"?>"> <span id="<?php echo $option_name2;?>_view" class="view_main">
                      <?php if(get_option($option_name2) !=""){?>
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name2;?>','D','<?php echo get_option($option_name2);?>');"><?php echo $ad_demo_company_name2;?></a></span><span id="<?php echo $option_name2;?>_detail_popup" class="detail_View">&nbsp;
                      <?php }/*else{*/?>
                      </span>
                      <select name="<?php echo $option_name2;?>" id="<?php echo $option_name2;?>">
                        <option value="">- SELECT AD -</option>
                      ...
                      <?php /*?><span  id="<?php echo $option_name2;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name2;?>_select','D');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                    <div class="col" id="<?php echo $option_name3."_main"?>"> <span id="<?php echo $option_name3;?>_view" class="view_main">
                      <?php if(get_option($option_name3) !=""){?>
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name3;?>','D','<?php echo get_option($option_name3);?>');"><?php echo $ad_demo_company_name3;?></a></span><span id="<?php echo $option_name3;?>_detail_popup" class="detail_View">&nbsp;
                      <?php }/*else{*/?>
                      </span>
                      <select name="<?php echo $option_name3;?>" id="<?php echo $option_name3;?>">
                        <option value="">- SELECT AD -</option>
                      ...
                      <?php /*?><span  id="<?php echo $option_name3;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name3;?>_select','D');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                    <div class="col" id="<?php echo $option_name4."_main"?>"> <span id="<?php echo $option_name4;?>_view" class="view_main">
                      <?php if(get_option($option_name4) !=""){?>
                      &nbsp;<a href="javascript:detailPopup('<?php echo $option_name4;?>','D','<?php echo get_option($option_name4);?>');"><?php echo $ad_demo_company_name4;?></a></span><span id="<?php echo $option_name4;?>_detail_popup" class="detail_View">&nbsp;
                      <?php }/*else{*/?>
                      </span>
                      <select name="<?php echo $option_name4;?>" id="<?php echo $option_name4;?>">
                        <option value="">- SELECT AD -</option>
                      ...
                      <?php /*?><span  id="<?php echo $option_name4;?>_select" class="hide"><a href="javascript:AdPopup('<?php echo $option_name4;?>_select','D');">- SELECT AD -</a></span><?php */?>
                      <?php /*}*/?>
                    </div>
                  </div>
                  <script type="text/javascript">
...
function load_image(id,ext){
	...
	function detailPopup(id,type,selected_ad){
	 ...
	 jQuery.ajax({	
				url:'<?php echo get_site_url();?>/ajax.php',	
				type:'POST',
				data:{'mode':'getDetailAD','ad_id':id,'type':type,'selected_ad':selected_ad},
				beforeSend: function() {},
				complete: function() {
				},
				success:function (data){
